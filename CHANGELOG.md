...
- Change: A number of logic settings have been changed for consistency and fairness
    ...
    - The later woodlands already ignored what candles and backpacks are worth, since neither helps that early. It now also ignores the bonus the Backpack Node earns by pairing with Smaller Backpack Challenge, making that fight one point stricter when you hold both
