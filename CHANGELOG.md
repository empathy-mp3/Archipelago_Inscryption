### 1.5.0
 ...
 - Fixed a bug where finishing Act 2 sent you into Act 3 even when Act 3 wasn't available to you. The end of Act 2 loads Act 3 unconditionally, without consulting your options, so it happened both when Act 3 was disabled entirely and when it was still locked behind its item under `act_unlocks: items`. It now returns you to the act select menu instead. Sequential act unlocks are unaffected, since finishing Act 2 is exactly what unlocks Act 3 there.
